...
The distribution of average glucose level across stroke groups does appear to differ. Though both plots show a bit of a bi-modal distribution, the stroke group = 1 group
