...
errorRates <- vector()
for (i in 1:5){
  fold <- my_folds[[i]] #need to make this fold_num somehow
...
Though the models have nearly identical evaluation metrics: Ridge $R^2 =$`r rsq` and $MSE =$ `r my_mse` while Lasso had values of: $R^2 =$ `r rsq2` and $MSE =$ `r my_mse2`, I would go with lasso, because lasso allows us to remove variables from the model thus simplifying the model.
